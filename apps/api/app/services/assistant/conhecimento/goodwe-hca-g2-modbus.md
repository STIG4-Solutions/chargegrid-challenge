<!-- GERADO por scripts/exportar_conhecimento.py a partir de docs/references/goodwe/hca-g2-modbus-map.md. Nao edite: rode o script. -->
<!-- titulo: Mapa Modbus do GoodWe HCA G2 -->
