  ...
  return (
    <div>
      ...
      <div className="grid grid-4" style={{ marginBottom: 16 }}>
        <div className="stat">
          <div className="label">Geração hoje</div>
          <div className="value">
            1,9<small>kWh</small>
          </div>
        </div>
        <div className="stat">
          <div className="label">Geração mês</div>
          <div className="value">
            148,2<small>kWh</small>
          </div>
        </div>
        <div className="stat">
          <div className="label">Geração total</div>
          <div className="value">
            3.631,6<small>kWh</small>
          </div>
        </div>
        <div className="stat">
          <div className="label">CO₂ evitado</div>
          <div className="value">
            2,58<small>t</small>
          </div>
        </div>
